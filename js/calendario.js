document.addEventListener('init', function (event) {
    ...
    if (page.id === 'calendario') {
                ...
                obtenerProductosDelDia(new Date(año, mes, i + 1), function (productosDelDia) {
                    if (productosDelDia.length > 0) {
                        ...
                        productosDelDia.forEach(producto => {
                            ...
                            codigoProductoElemento.textContent = producto.o_c.slice(0, -2);
        ...
        function obtenerProductosDelDia(fecha, callback) {
            let link = "https://empaquessr.com/sistema/php/cinthya/lista_pedidos_lamina/select.php?type=1&proveedor=1";
