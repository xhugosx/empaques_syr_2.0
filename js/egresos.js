...
function setMesProveedorEgreso(tipo)
{
  ...
  servidor("https://empaquessr.com/sistema/php/cinthya/egresos/egresoMensualTipo.php?anio="+anio+"&mes="+mes+"&tipo="+tipo,getMesProveedorEgreso);
}
...
function setMesEgreso(mes)
{
  ...
  servidor("https://empaquessr.com/sistema/php/cinthya/egresos/egresoMensual.php?anio="+anio+"&mes="+mes,getMesEgreso);
}
...
function setEgresos()
{
  ...
  var anio = $("#anioG").text();
  servidor('https://empaquessr.com/sistema/php/cinthya/egresos/egresoTotal.php?anio='+anio,getEgresos);
}
...
{
  servidor("https://empaquessr.com/sistema/php/cinthya/proveedores/select.php?type=0", getEgresoProveedor);
}
...
{
  servidor("https://empaquessr.com/sistema/php/cinthya/proveedores/select.php?search="+id+"&type=0",getEgresoTipo)
}
...
function setModificarEgreso()
{
  ...
  {
    servidorPost("https://empaquessr.com/sistema/php/cinthya/egresos/update.php?id="+id,getModificarEgreso,formData);
  }
...
function setAgregarEgreso()
{
  ...
  if(vacio(proveedor,fecha,importe,metodoPago))
  {
    servidorPost("https://empaquessr.com/sistema/php/cinthya/egresos/add.php",getAgregarEgreso,formData);
  }
  else alerta("Espacios vacios!");
  //servidor(,)
}
...
{
  servidor("https://empaquessr.com/sistema/php/cinthya/egresos/select.php?id="+id,getBuscarEgreso);
}
...
{
  servidor("https://empaquessr.com/sistema/php/cinthya/egresos/delete.php?id="+id,getEliminarEgreso);
}
