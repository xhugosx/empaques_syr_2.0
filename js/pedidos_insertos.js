...
{
    //console.log("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/add.php?codigo="+datos[0]+"&resistencia="+datos[1]+"&cantidad="+datos[2]+"&observaciones="+datos[3]+"&fecha_oc="+datos[4]+"&notas="+datos[5]);
    servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/add.php?codigo="+datos[0]+"&resistencia="+datos[1]+"&cantidad="+datos[2]+"&observaciones="+datos[3]+"&fecha_oc="+datos[4]+"&notas="+datos[5],getAgregaPedidoInserto);
}
...
function setPedidosInsertos()
{
    ...
    if(busqueda == "" || busqueda == undefined)servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/selectAll.php?filtro=" + filtroGlobal + "&estado=" + estadoGlobal+"&anio=" + anioGlobal,getPedidosInsertos);
...
{
    servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/delete.php?id="+id,getEliminarpedidoInserto);
}
...
{
    //var type = filtro ? 1 : 2;
    servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/selectAllEditar.php?id="+id,getModificarBuscarPedidoInserto);
...
function setModificarPedidoInserto()
{
    ...
    {
        servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/update.php?resistencia="+resistencia+"&cantidad="+cantidad+"&id="+id+"&observaciones="+observaciones+"&notas="+notas,getModificarPedidoInserto)
    }
...
function setSearchPedidosInsertos(search,e)
{
    ...
    {
        //var type = filtro ? 1 : 2;
        servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/selectAll.php?search="+search+"&filtro=" + filtroGlobal + "&estado=" + estadoGlobal,getSearchPedidosInsertos);
    }
...
function setActualizarEstadoPedidoInserto(datos) {
    let id = datos[0];
    let estado = datos[1];
    servidor("https://empaquessr.com/sistema/cinthya/php/lista_pedidos_inserto/updateEstado.php?id=" + id + "&estado=" + estado, getActulizarestadoPedidoInserto);
}
