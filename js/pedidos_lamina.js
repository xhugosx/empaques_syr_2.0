...
function setMostrarBusquedaLamina(search, e) {
    ...
    if (tecla == 13 || e == 13) {
        servidor('https://empaquessr.com/sistema/php/lista_pedidos_lamina/select.php?proveedor=1&search=' + search + '&type=' + tipo, getMostrarPedidosLamina);
    }
...
function setMostrarBusquedaLaminaPack(search, e) {
    ...
    var tipo = filtroLamina ? 2 : 1;
    if (tecla == 13 || e == 13) {
        servidor('https://empaquessr.com/sistema/php/lista_pedidos_lamina/select.php?proveedor=2&search=' + search + '&type=' + tipo, getMostrarPedidosLaminaPACK);
    }
...
function setMostrarPedidosLaminaFecha(fecha) {
    ...
    servidor("https://empaquessr.com/sistema/php/lista_pedidos_lamina/selectDate.php?fecha=" + fecha, getMostrarPedidosLaminaFecha)
}
...
function setMostrarPedidosLamina() {
    var tipo = filtroLamina ? 2 : 1;
    servidor("https://empaquessr.com/sistema/php/lista_pedidos_lamina/select.php?proveedor=1&type=" + tipo, getMostrarPedidosLamina)
}
...
function setMostrarPedidosLaminaPACK() {
    var tipo = filtroLamina ? 2 : 1;
    servidor("https://empaquessr.com/sistema/php/lista_pedidos_lamina/select.php?proveedor=2&type=" + tipo, getMostrarPedidosLaminaPACK)
}
...
function setAgregarPedidoLamina() {
    ...
    if (datoVacio(o_c) && datoVacio(ancho) && datoVacio(largo) && datoVacio(p_o) && datoVacio(resistencia) && datoVacio(fecha) && datoVacio(proveedor) && datoVacio(papel) && datoVacio(fecha_entrega))
        servidorPost("https://empaquessr.com/sistema/php/lista_pedidos_lamina/add.php", getAgregarPedidoLamina, formData);
...
function setActualizarEstadoPL(estado, o_c, cantidad, entrada) {
    //alert('https://empaquessr.com/sistema/php/lista_pedidos_lamina/updateEntrada.php?id_lp='+o_c+'&cantidad='+cantidad+'&entrada='+entrada+'&estado='+estado);
    servidor('https://empaquessr.com/sistema/php/lista_pedidos_lamina/updateEntrada.php?id_lp=' + o_c + '&cantidad=' + cantidad + '&entrada=' + entrada + '&estado=' + estado, getActualizarEstadoPL)
}
...
function setBuscarActualizarPL(search) {
    var tipo = filtroLamina ? 2 : 1;
    servidor('https://empaquessr.com/sistema/php/lista_pedidos_lamina/select.php?search=' + search + "&type=" + tipo, getBuscarActualizarPL);
}
...
function setActualizarPL() {
    ...
    if (datoVacio(o_c) && datoVacio(ancho) && datoVacio(largo) && datoVacio(p_o) && datoVacio(resistencia) && datoVacio(fecha) && datoVacio(proveedor) && datoVacio(papel) && datoVacio(fecha_entrega))
        servidorPost("https://empaquessr.com/sistema/php/lista_pedidos_lamina/update.php?&o_c=" + o_cTemp, getActualizarPL, formData);
    else alerta("Existen datos vacios");
...
function setEliminarPL(o_c) {
    servidor('https://empaquessr.com/sistema/php/lista_pedidos_lamina/delete.php?o_c=' + o_c, getEliminarPL);
}
