...
function setIngresoMensualCliente(datos) {
  ...
  //console.log("https://empaquessr.com/sistema/cinthya/php/ingresos/ingresoMensualCliente.php?anio="+anio+"&mes="+mes+"&cliente="+cliente);
  servidor("https://empaquessr.com/sistema/cinthya/php/ingresos/ingresoMensualCliente.php?anio=" + anio + "&mes=" + mes + "&cliente=" + cliente, getIngresoMensualCliente);
}
...
function setMesIngreso(mes) {
  ...
  servidor("https://empaquessr.com/sistema/cinthya/php/ingresos/ingresoMensual.php?anio=" + anio + "&mes=" + mes, getMesIngreso);
}
...
function setIngresos() {
  ...
  var anio = $("#anioG").text();
  servidor('https://empaquessr.com/sistema/cinthya/php/ingresos/ingresoTotal.php?anio=' + anio, getIngresos);
}
...
function setIngresoClientes() {
  servidor("https://empaquessr.com/sistema/cinthya/php/clientes/select.php?type=2", getIngresoClientes)
}
...
function setAgregarIngreso() {
  ...
  if (vacio(cliente, fecha, factura, importe, metodoPago)) {
    servidorPost("https://empaquessr.com/sistema/cinthya/php/ingresos/add.php", getAgregarIngreso, formData);
  }
...
function setEliminarIngreso(id) {
  servidor("https://empaquessr.com/sistema/cinthya/php/ingresos/delete.php?id=" + id, getEliminarIngreso);
}
...
function setBuscarIngreso(id) {
  servidor("https://empaquessr.com/sistema/cinthya/php/ingresos/select.php?id=" + id, getBuscarIngreso);
}
...
function setModificarIngreso() {
  ...
  if (vacio(cliente, fecha, factura, importe, metodoPago)) {
    servidorPost("https://empaquessr.com/sistema/cinthya/php/ingresos/update.php?id=" + id, getModificarIngreso, formData);
  }
  else alerta("Espacios vacios!");
