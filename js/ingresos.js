...
function setIngresos()
{
  ...
  var anio = $("#anioG").text();
  servidor('https://empaquessyrgdl.000webhostapp.com/empaquesSyR/ingresos/ingresoTotal.php?anio='+anio,getIngresos);
}
...
{
  servidor("https://empaquessyrgdl.000webhostapp.com/empaquesSyR/clientes/select.php?type=2",getIngresoClientes)
}
...
function setAgregarIngreso()
{
  ...
  {
    servidorPost("https://empaquessyrgdl.000webhostapp.com/empaquesSyR/ingresos/add.php",getAgregarIngreso,formData);
  }
