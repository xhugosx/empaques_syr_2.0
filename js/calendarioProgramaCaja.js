document.addEventListener('init', function (event) {
    ...
    if (page.id === 'historialProgramaCajas') {
        ...
        // Obtiene todos los registros de un año (1 sola vez por año)
        function obtenerProductosDelAño(añoReq, callback) {
            if (productCache[añoReq]) {
                return callback(productCache[añoReq]);
            }
            let link = myLink + "/php/programa/historial/caja.php?anio=" + añoReq;
        ...
        function mostrarCalendario() {
            ...
            obtenerProductosDelAño(año, function (productos) {
                ...
                productos.forEach(prod => {
                    if (Array.isArray(prod.programa)) {
                        prod.programa.forEach(programa => {
