...
function setMostrarInventarioInsertoSearch(search, e) {
    ...
    if (tecla == 13 || e == 13) {
        ...
        servidor("https://empaquessr.com/sistema/cinthya/php/inventario/selectInsertoAll.php?search=" + search, getMostrarInventarioInserto);
    }
...
function setMostrarInventarioInserto() {
    ...
    if (busqueda == "" || busqueda == undefined) servidor("https://empaquessr.com/sistema/cinthya/php/inventario/selectInsertoAll.php", getMostrarInventarioInserto);
    else {
        //alerta("entro");
...
function setMostrarInventarioPedidosInserto(array) {
    ...
    servidor('https://empaquessr.com/sistema/cinthya/php/inventario/selectCodigoInserto.php?codigo=' + array[0] + '&inserto=' + array[1], getMostrarInventarioPedidosInserto);
}
...
function setMostrarInventarioSearch(search, e) {
    ...
    if (tecla == 13 || e == 13) {
        ...
        servidor("https://empaquessr.com/sistema/cinthya/php/inventario/select.php?search=" + search, getMostrarInventario);
    }
...
function setMostrarInventario() {
    ...
    if (busqueda == "") servidor("https://empaquessr.com/sistema/cinthya/php/inventario/select.php", getMostrarInventario);
...
function setActualizarSalida(salida, cantidad, id) {
    ...
    if (codigo[0].length >= 7)
        servidor("https://empaquessr.com/sistema/cinthya/php/inventario/updateSalida.php?cantidad=" + cantidad + "&id_lp=" + id + "&salida=" + salida, getActualizarSalida);
    else servidor("https://empaquessr.com/sistema/cinthya/php/inventario/updateSalidaInserto.php?cantidad=" + cantidad + "&id_lp=" + id + "&salida=" + salida, getActualizarSalida);
...
function setSalidaTotal(codigo) {
    ons.notification.confirm({
        ...
        callback: function (idx) {
            if (idx == 0) servidor("https://empaquessr.com/sistema/cinthya/php/inventario/updateSalidaTodo.php?codigo=" + codigo, getActualizarSalida);;
        }
    });
...
function setSalidaTotalInserto(codigo, inserto) {
    ons.notification.confirm({
        ...
        buttonLabels: ['SI', 'NO'],
        callback: function (idx) {
            if (idx == 0) servidor("https://empaquessr.com/sistema/cinthya/php/inventario/updateSalidaTodoInserto.php?codigo=" + codigo + "&inserto=" + inserto, getActualizarSalida);;
        }
    });
...
function setMostrarInventarioPedidos(codigo) {
    ...
    servidor('https://empaquessr.com/sistema/cinthya/php/inventario/selectCodigo.php?codigo=' + codigo, getMostrarInventarioPedidos);
}
...
function setMostrarInventarioPedidosLaminaSearch(search, e) {
    ...
    if (tecla == 13 || e == 13) {
        ...
        servidor('https://empaquessr.com/sistema/cinthya/php/inventario/selectLamina.php?search=' + search, getMostrarInventarioPedidosLamina);
    }
...
function setMostrarInventarioPedidosLamina() {
    ...
    if (busqueda == "" || busqueda == undefined) servidor('https://empaquessr.com/sistema/cinthya/php/inventario/selectLamina.php', getMostrarInventarioPedidosLamina);
...
function setActualizarSalidaLamina(json) {
    servidor("https://empaquessr.com/sistema/cinthya/php/inventario/updateSalidaLamina.php?id_lp=" + json.codigo + "&cantidad=" + json.inventario + "&salida=" + json.salida, getActualizarSalidaLamina)
}
