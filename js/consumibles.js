...
function setMostrarConsumibleSearch(search, e) {
    ...
    if (tecla == 13 || e == 13) {
        ...
        servidor('https://empaquessr.com/sistema/php/consumibles/select.php?search=' + search, getConsumibles);
    }
    else if (search == "") {
        $("#consumibleLoading").empty();
        $("#consumibleLoading").append("<ons-progress-bar indeterminate></ons-progress-bar>");
...
function setMostrarConsumible0Search(search, e) {
    ...
    if (tecla == 13 || e == 13) {
        ...
        servidor('https://empaquessr.com/sistema/php/consumibles/selectSinExistencia.php?search=' + search, getConsumible0);
    }
    else if (search == "") {
        $("#consumible0Loading").empty();
        $("#consumible0Loading").append("<ons-progress-bar indeterminate></ons-progress-bar>");
...
function setConsumible0() {
    ...
    if (busqueda == "" || busqueda == undefined) servidor('https://empaquessr.com/sistema/php/consumibles/selectSinExistencia.php', getConsumible0);
...
function setConsumible() {
    ...
    if (busqueda == "" || busqueda == undefined) servidor('https://empaquessr.com/sistema/php/consumibles/select.php', getConsumibles);
...
function setAgregarConsumible() {
    ...
    if (datoVacio(descripcion) && datoVacio(cantidad)) {
        servidor('https://empaquessr.com/sistema/php/consumibles/add.php?&descripcion=' + descripcion + '&cantidad=' + cantidad, getAgregarConsumible);
    }
...
function setEliminarConsumible(id) {
    servidor('https://empaquessr.com/sistema/php/consumibles/delete.php?id=' + id, getEliminarConsumible)
}
...
function setActualizarConsumible(id) {
    ...
    if (cantidad >= 0) servidor('https://empaquessr.com/sistema/php/consumibles/update.php?id=' + id + '&cantidad=' + cantidad, getActualizarConsumible);
...
function setActualizarConsumibleDes(id) {
    ...
    if (vacio(descripcion)) servidor('https://empaquessr.com/sistema/php/consumibles/updateDes.php?id=' + id + '&descripcion=' + descripcion, getActualizarConsumibleDes);
