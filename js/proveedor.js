...
function setBuscarEditarProveedor(id) {
    servidor('https://empaquessyrgdl.000webhostapp.com/empaquesSyR/proveedores/select.php?search=' + id + '&type=0', getBuscarEditarProveedor);
}
...
function setEditarProveedor() {
    ...
    var tipo = $('#selectTipo').val();
    if (vacio(id, nombre, tipo)) servidor("https://empaquessyrgdl.000webhostapp.com/empaquesSyR/proveedores/update.php?id=" + id + "&nombre=" + nombre + "&tipo=" + tipo, getEditarProveedor);
    else alerta("Espacios vacios!");
