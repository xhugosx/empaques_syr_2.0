...
function setProveedorBarraBusqueda(busqueda, e) {
    ...
    if (tecla == 13) {
        ...
        servidor('https://empaquessr.com/sistema/cinthya/php/proveedores/select.php?search=' + busqueda + '&type=' + tipoFilter, getProveedor);
    }
...
function setProveedor() {
    ...
    servidor('https://empaquessr.com/sistema/cinthya/php/proveedores/select.php?type=' + tipoFilter, getProveedor);
}
...
function setAgregarProveedor() {
    ...
    if (vacio(nombre, tipo)) {
        servidor("https://empaquessr.com/sistema/cinthya/php/proveedores/add.php?nombre=" + nombre + "&tipo=" + tipo, getAgregarProveedor);
    }
...
function setEliminarProveedor(codigo) {
    servidor('https://empaquessr.com/sistema/cinthya/php/proveedores/delete.php?codigo=' + codigo, getEliminarProveedor);
}
...
function setBuscarEditarProveedor(id) {
    servidor('https://empaquessr.com/sistema/cinthya/php/proveedores/select.php?search=' + id + '&type=0', getBuscarEditarProveedor);
}
...
function setEditarProveedor() {
    ...
    var tipo = $('#selectTipo').val();
    if (vacio(id, nombre, tipo)) servidor("https://empaquessr.com/sistema/cinthya/php/proveedores/update.php?id=" + id + "&nombre=" + nombre + "&tipo=" + tipo, getEditarProveedor);
    else alerta("Espacios vacios!");
